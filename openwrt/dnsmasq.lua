-- Based on https://github.com/openwrt/packages/pull/12250
-- Put to /usr/lib/lua/prometheus-collectors
-- Then follow https://grafana.com/blog/2021/02/09/how-i-monitor-my-openwrt-router-with-grafana-cloud-and-prometheus/
    ...
    if e then
      ...
      if fields[4] ~= nil then
        ...
        if string.match(fields[3], "^[0-9]+%.[0-9]+%.[0-9]+%.[0-9]+$") then
          labels['mac'] = string.upper(fields[2])
        end
